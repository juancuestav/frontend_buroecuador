<template>
  <q-page padding>
    ...
    <q-form @submit.prevent>
      <div class="row q-col-gutter-sm q-pa-sm bg-desenfoques">
        <!-- Puntaje actual -->
        <div class="col-12 col-md-3">
          ...
          >
            <template v-slot:error>
              <div v-for="error of v$.puntaje_actual.$errors" :key="error.$uid">
        ...
        <div class="col-12 col-md-3">
          ...
          >
            <template v-slot:error>
              <div v-for="error of v$.puntaje_subir.$errors" :key="error.$uid">
                <div class="error-msg">{{ error.$message }}</div>
              </div>
            </template>
          </q-select>
